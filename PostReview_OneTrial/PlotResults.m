% Plots the results of hemodynamics simulation
...
param_tit = sprintf('lambda = %.2f, s = %d, T = %.2f, L = %.0f cm, h = %1.2f cm, P_{ext} = %1.2f mmHg, P_{out} = %1.2f mmHg\nR_0 = %1.2f mmHg.s/cm^3, R = %1.2f mmHg.s/cm^3, C = %1.2f cm^3/mmHg\n U_0 = %1.2f cm/s, Tapering = %.2f, ref-rad = %.2f cm\ndx = %1.2e, dt = %.2e, MM=%d, NN = %d, MMp = %d\n',lambda,s,T,L,h,Pext,P0,Res0,Res,C,U0,tapering_factor,ref_rad,dx,dt,MM,NN,MMp);
